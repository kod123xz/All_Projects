$(document).ready(function(){
    $('.header__burger,.header__burger__sub').click(function(event) {
        $('.header__burger,.header__burger__sub,.header__menu__sub').toggleClass('active');
    });
    
    $('.header__burger,.header__burger__sub,.header__menu,.header__menu__sub,.header__link').fadeIn(600);
